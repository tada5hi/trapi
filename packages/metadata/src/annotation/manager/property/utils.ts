...
import type {
    RepresentationPropertyConfig, RepresentationPropertyStrategy,
} from '../../type';
import type { NodeDecorator } from '../../../utils';
import { hasOwnProperty } from '../../../utils';

export function extendRepresentationPropertyConfig(property: RepresentationPropertyConfig): RepresentationPropertyConfig {
...
export function extractRepresentationPropertyValue(
    ...
    config: RepresentationPropertyConfig,
): unknown | undefined {
    let items : unknown[] = [];
    ...
    const srcStrategy : RepresentationPropertyStrategy = config.srcStrategy ?? 'none';
