...
## [0.1.8](https://github.com/tada5hi/trapi/compare/preset-decorators-express-v0.1.7...preset-decorators-express-v0.1.8) (2024-09-29)
...
* The following workspace dependencies were updated
  * dependencies
    * @trapi/decorators bumped from ^1.2.3 to ^1.2.4
  * devDependencies
